...
#define PLUGINDIR "/usr/lib/x86_64-linux-gnu/mariadb19/plugin"
...
#define PACKAGE_STRING "MySQL Server 10.3.22"
#define PACKAGE_TARNAME "mysql"
#define PACKAGE_VERSION "10.3.22"
#define VERSION "10.3.22"
